...
* **Get the images of an episode**
    TMDB.television('3199').season(2).episodes(1).images().end().run()
    Data.filter().images().output()
...
* **Get the images of a season**
    TMDB.television('3199').season(2).images().end().run()
    Data.filter().images().output()
...
* **Get the images of a series**
    TMDB.television('3199').images().end().run()
    Data.filter().images().output()

* **Get the keywords of a series**
    TMDB.television('3199').keywords().end().run()
    Data.filter({ location: 'US' }).images().output()
...
* **Get the images of a company**
    TMDB.company().images().end().run()
    DATA.filter().images().output()
...
* **Get the images of a person**
    TMDB.people('297').images().end().run()
    DATA.filter().images().output()
